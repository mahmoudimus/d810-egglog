...
from egglog import EGraph, Expr, StringLike, eq, rewrite, vars_  # noqa: E402
...
def test_xor_not_equivalence_from_module():
    ...
    try:
        from d810_egglog.rule_analysis import PatternExpr as ModulePatternExpr
        from d810_egglog.rule_analysis import verify_pattern_equivalence
    except ImportError:
