...
_PROFILE_ROOT = _ROOT / "src/d810_egglog/profiles"
_CONFIG = _PROFILE_ROOT / "mba_portfolio_spike.json"
_TELEMETRY_CONFIG = _PROFILE_ROOT / "mba_portfolio_telemetry_3ms.json"
_DEEP_CONFIG = _PROFILE_ROOT / "mba_portfolio_deep.json"
